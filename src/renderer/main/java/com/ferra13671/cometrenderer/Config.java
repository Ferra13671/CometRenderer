...
public class Config {
    ...
    public final NumberSetting<Integer> MINIMUM_OPENGL_VERSION = new NumberSetting<>(GLVersion.GL33.id, GLVersion.GL33.id, GLVersion.GL46.id);
    ...
    public final NumberSetting<Integer> MAX_INDICES = new NumberSetting<>(0, 0, Integer.MAX_VALUE); //Sets from CometTags.MAX_INDICES after init
}
