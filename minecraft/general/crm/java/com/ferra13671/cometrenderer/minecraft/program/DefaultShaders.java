...
public class DefaultShaders {
    public final GLShader POSITION_VERTEX = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader POSITION_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader POSITION_COLOR_VERTEX = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader POSITION_COLOR_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader POSITION_TEXTURE_VERTEX = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader POSITION_TEXTURE_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader POSITION_TEXTURE_COLOR_VERTEX = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader POSITION_TEXTURE_COLOR_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader ROUNDED_RECT_VERTEX = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader ROUNDED_RECT_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader ROUNDED_TEXTURE_VERTEX = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader ROUNDED_TEXTURE_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader BLUR_FRAME_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader ROUNDED_BLUR_VERTEX = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader ROUNDED_BLUR_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader BLIT_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
    ...
    public final GLShader LIQUID_GLASS_FRAGMENT = CometLoader.IN_JAR.createShaderBuilder()
            .info(
