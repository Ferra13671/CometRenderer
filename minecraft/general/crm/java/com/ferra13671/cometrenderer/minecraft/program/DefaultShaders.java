...
public class DefaultShaders {
    public final GLShader POSITION_VERTEX = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader POSITION_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader POSITION_COLOR_VERTEX = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader POSITION_COLOR_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader POSITION_TEXTURE_VERTEX = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader POSITION_TEXTURE_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader POSITION_TEXTURE_COLOR_VERTEX = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader POSITION_TEXTURE_COLOR_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader ROUNDED_RECT_VERTEX = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader ROUNDED_RECT_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader ROUNDED_TEXTURE_VERTEX = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader ROUNDED_TEXTURE_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader BLUR_FRAME_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader ROUNDED_BLUR_VERTEX = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader ROUNDED_BLUR_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader BLIT_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
    ...
    public final GLShader LIQUID_GLASS_FRAGMENT = GLShader.builder(GLSLLoader.IN_JAR)
            .info(
